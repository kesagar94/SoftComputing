...
public class HomeLoan extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fe.setText("•       No Advance EMI;\n"
				...
				+ "•       Low interest rates ;\n" + "•       Low EMI");
		fe2.setText("To avail Home Loan, you should be :\n"
